...
public class PO_View {
	...
	static public boolean checkElementExists(WebDriver driver, String type, String text) {
		boolean result = SeleniumUtils.existeElemento(driver, type, text, getTimeout());
		return result;
	}
	
	static public int countElements(WebDriver driver, String type, String text) {
		List<WebElement> elementos = SeleniumUtils.EsperaCargaPagina(driver, type, text, getTimeout());
