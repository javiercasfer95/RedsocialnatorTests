...
public class SeleniumUtils {
	...
	/**
	 * Comprueba que NO existe un elemento
	 * 
	 * @param driver
	 * @param criterio
	 * @param text
	 ...
	 * @return
	 */
	static public boolean existeElemento(WebDriver driver, String criterio, String text, int timeout) {
		String busqueda;
		if (criterio.equals("id"))
			busqueda = "//*[contains(@id,'" + text + "')]";
		else if (criterio.equals("class"))
		...
		List<WebElement> elementos = driver.findElements(By.xpath(busqueda));

		boolean result = !elementos.isEmpty();
		return result;
	}
